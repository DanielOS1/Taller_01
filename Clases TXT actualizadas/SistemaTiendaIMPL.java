...
public class SistemaTiendaIMPL implements SistemaTienda{
    ...
    public boolean AgregarPersonaje(String nombrePersonaje, String rolPersonaje, int recaudacion){
        Personaje personaje = new Personaje(nombrePersonaje,rolPersonaje,recaudacion);
